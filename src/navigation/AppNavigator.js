...
import ProductVue from '../screens/ProductVue';
...
export default function AppNavigator() {
  return (
    <NavigationContainer>
      <Stack.Navigator initialRouteName="ProductVue">
        ...
        <Stack.Screen name="ProductVue" component={ProductVue} options={{ title: 'demo de ProductVue' }} />
      </Stack.Navigator>
    </NavigationContainer>
  );
}
